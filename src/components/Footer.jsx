  ...
  return (
    <>
      <div className='bg-black h-[100%] rounded-[20px] max-sm:hidden mt-[-35px] flex flex-row justify-center'>
        ...
        <Link to='/contacts' className='p-4 md:flex hidden font-poppins text-greyLighter text-[18px]'>Kontaktai</Link>
        <Link to='/prices' className='p-4 md:flex hidden font-poppins text-greyLighter text-[18px]'>Kainoraštis</Link>
        <Link to='/contacts' className='p-2 md:hidden font-poppins text-greyLighter text-[16px]'>Kontaktai</Link>
        <Link to='/prices' className='p-2 md:hidden font-poppins text-greyLighter text-[16px]'>Kainoraštis</Link>
        </div>
        <div className='flex flex-row justify-center items-center w-1/2 '>
          <h1 className='p-4 md:flex hidden font-poppins text-white text-[30px]'>Deimantinis Gręžimas</h1>
          <h1 className='p-2 md:hidden font-poppins text-white text-[20px]'>Deimantinis Gręžimas</h1>
        </div>
      ...
      <div className='bg-black h-[100%] rounded-[20px] sm:hidden mt-[-35px] flex justify-center items-center '>
        <div className="flex justify-center items-center mb-1">
          ...
          <h1 className='p-2 font-poppins text-white text-[16px] '>Deimantinis Gręžimas</h1>
